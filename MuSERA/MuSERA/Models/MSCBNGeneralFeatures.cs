...
{
    /// <summary>
    /// Multi-Select ComboBox Node for General Features.
    /// </summary>
    internal class MSCBNGeneralFeatures : INotifyPropertyChanged
    {
        public MSCBNGeneralFeatures(bool isChecked, uint smapleID, byte featureCode)
        {
