...
{
    internal class PlotSamplesPValueDistribution
    {
        public PlotSamplesPValueDistribution(ChartPlotter chartPlotter,
        ...
        public void Plot(Dictionary<uint, PValueDistributions> data, Dictionary<uint, string> labels, PlotOptions plotOptions)
        {
            ...
            foreach (var sample in data)
            {
                ...
                foreach (var item in sample.Value)
                    points.Add(item.logpValue, item.frequency);

                PlotLineGraph(points, plotOptions.SampleColor[sample.Key], plotOptions.SampleColor[sample.Key], labels[sample.Key]);
            }
            UpdateAxes();
