...
namespace Polimi.DEIB.VahidJalili.MuSERA.Warehouse.Classes
{
    public class ChrWideStat
    {
        ...
        /// <summary>
        /// gets and set the total number of Multiple-Testing Confirmed peaks count in Output set on the chromosome
        /// </summary>
        public uint R_j_TP_c { set; get; }

        /// <summary>
        /// gets and sets the percentage of Multiple-Testing Confirmed peaks count in Output set on the chromosome.
        /// </summary>
        public string R_j_TP_p { set; get; }

        /// <summary>
        /// gets and set the total number of Multiple-Testing Discarded peaks count in Output set on the chromosome
        /// </summary>
        public uint R_j_FP_c { set; get; }

        /// <summary>
        /// gets and sets the percentage of Multiple-Testing Discarded peaks count in Output set on the chromosome.
        /// </summary>
